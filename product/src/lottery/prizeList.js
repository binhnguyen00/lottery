...
let prizes;
const DEFAULT_MESS = [
  "Nên đoạt giải nhất hay giải nhất rối ...",
  "Tôi nghe nói rằng bạn phải ăn chay trước một tháng để trúng số độc đắc!",
  "Tôi thực sự muốn giải nhất !!!",
  "Có ai muốn giải nhất không?",
  "Giải năm cũng được, miễn là đạt giải",
  "Chúc các bạn năm mới An khang thịnh vượng!",
  "Thắng hay không không quan trọng, mọi người hãy ăn uống đầy đủ.",
  "Năm mới, tôi chúc bạn mọi điều tốt đẹp nhất.",
  "Là một hộ tống chuyên nghiệp, tôi sẽ thấy ai trong số các bạn giống tôi",
  "Năm mới chúc mọi người ngày càng tốt hơn!",
  "Chiến đấu lại vào năm sau !!!",
];
...
function test() {
  addQipao(`Chúc mừng những bạn, Năm mới an khang thịnh vượng.`);
}
